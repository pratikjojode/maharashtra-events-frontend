...
const speakers = [
  {
    ...
    description:
      "Shri Chandrakant Patil serves as the Minister of Higher and Technical Education for Maharashtra. A visionary leader, he has been at the forefront of revolutionizing the educational landscape of the state through policy reforms and innovative initiatives.",
    ...
    quote:
      "Our aim is to make Maharashtra a global hub for quality education that produces not just graduates, but future-ready professionals and innovators.",
  ...
  },
  {
    ...
    description:
      "Harshwardhan Patil is a respected political figure who served as a member of the Maharashtra Legislative Assembly. With his extensive experience in public service, he has contributed significantly to educational policies and development initiatives across the state.",
    ...
    quote:
      "True development of a state begins with investing in quality education that reaches every corner and every citizen of our society.",
  ...
  },
  {
    ...
    image: paragImage,
    description:
      "Dr. Parag Kalkar is a distinguished academic leader serving as the Pro Vice Chancellor at Savitribai Phule Pune University. With over 25 years of experience in higher education, he has been instrumental in driving academic excellence and innovation across the university.",
    ...
    quote:
      "Education is not just about degrees; it's about empowering students to become thoughtful leaders who can solve real-world problems.",
          ...
          <div className="container">
            <div className="section-header">
              ...
              <p className="section-subtitle">
                Meet the visionaries shaping the future of education in
                Maharashtra
              </p>
            </div>
                ...
                <div className="speaker-card" key={index}>
                  ...
                  <div className="speaker-info">
                    ...
                    >
                      ...
                      <FaArrowRight
                        className={
                          activeProfile === index ? "arrow-rotated" : ""
                        }
                      />
                    </button>
            ...
            <div className="conference-info">
              ...
              <p>
                Maharashtra Educational Awards recognize excellence in education
                across the state. Our distinguished speakers bring valuable
                insights and vision to this prestigious event, celebrating
                innovation and achievement in Maharashtra's educational
                landscape.
              </p>
              <p>
                Join us to hear from these thought leaders and be part of the
                conversation that will shape the future of education in our
                state.
              </p>
            </div>
          </div>
