...
import '../styles/LastYearAwardies.css'; // Using the enhanced CSS file
...
const LastYearAwardees = () => {
  ...
  const awardees = [
    ...
    { name: "Dr.Sandeep Pachpande", designation: "IBMR", image: SandeepPachpande },
    { name: "Dr. Ravikumar Chitnis", designation: "MIT", image: RavikumarChitnis },
    ...
    { name: "Dr. Eknath Khedkar", designation: "DR. DY Patil School of management Ambi", image: EknathKhedkar },
    { name: "Dr. Rajveer Bhardwaj", designation: "PCU", image: RajveerBhardwaj },
    { name: "Dr. Atulkumar Jain", designation: "DY patil", image: AtulkumarJain},
    ...
    { name: "Dr. Ramakrishnan Raman", designation: "SIBM", image: RamakrishnanRaman },
    { name: "Dr. Suraj Sharma", designation: "RIMS", image: SUrajSharma },
    { name: "Dr. Chetan Chaudhari", designation: "DY patil", image: ChetanChaudhari },
    { name: "Prof. Viraj Barge", designation: "Zeal education society", image: VirajBarge },
    { name: "Mr. Arjun Kale", designation: "MIT", image: ArjunKale },
    { name: "Mr. Tushar Badhe", designation: "Mauli College", image: TusharBadhe },
    { name: "Dr. Tushar Ram Sangole", designation: "JSPM", image: TusharRamSangole },
    { name: "Mr.Faisal Khan", designation: "DY Patil", image: FaisalKhan },
    { name: "Dr. Shital Kumar Rawandale", designation: "MITADT", image: ShitalKumarRawandale },
    { name: "Prof. Touheed Mujawar", designation: "CCDPs", image: TauheedMujawar },
    ...
    { name: "Dr. Zahir Alam", designation: "Thakur college of engineering", image: ZahirAlam },
    { name: "Dr. Ashutosh Misal", designation: "DYP", image: AshutoshMisal },
    { name: "Mr.Sudarshan Sutar", designation: "DYP", image: SudharshanSutar },
    { name: "Prof. Pramod Dastoorkar", designation: "MIT", image: PramodDastoorkar },
  ...
  return (
    <section className="last-year-awardees-section">
      <div className="container">
        ...
        <div className={`awardees-grid ${isAnimating ? 'animating' : ''}`}>
          {currentAwardees.map((awardee, index) => (
            <div 
              className={`awardee-card ${hoveredCard === index ? 'hovered' : ''}`}
              key={index}
              onMouseEnter={() => setHoveredCard(index)}
              onMouseLeave={() => setHoveredCard(null)}
            >
              <div className="awardee-image-container">
                <img src={awardee.image} alt={awardee.name} className="awardee-image" />
      ...
      {/* Navigation buttons with consistent positioning */}
